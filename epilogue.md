...
## 0 - Перечень сценариев навигации:
	1. Переход к тестированию возможности записи на обучение "Тестировщик ПО" через строку поиска в "Каталоге курсов":
	...
	* Проверка появления под строкой поиска необходимого курса (делаем клик по курсу)
	...
	2. Переход к тестированию возможности записи на обучение "Тестировщик ПО" через направления обучения в "Каталоге курсов":
	* Проверка открытия страницы netology.ru (вводим url в браузере);
	* Проверка наличия в заголовке страницы netology.ru формы "Каталог курсов" (делаем клик по форме);
	...
	* Проверка наличия необходимого курса путем прокрутки открывшейся страницы (делаем клик по курсу)
	...
	3. Переход к тестированию возможности записи на обучение "Тестировщик ПО" со страницы netology.ru через программы обучения в "Направления обучения":
	* Проверка открытия страницы netology.ru (вводим url в браузере);
	* Проверка наличия на странице заголовка "Направления обучения" (находим данный раздел путем прокрутки страницы netology.ru);
	* Проверка наличия программы обучения "Программирование" под заголовком "Направления обучения" (делаем клик по программе обучения "Программирование");
	* Проверка наличия необходимого курса путем прокрутки открывшейся страницы (делаем клик по курсу)
	
	4. Переход к тестированию возможности записи на обучение "Тестировщик ПО" со страницы netology.ru через полный каталог в "Направления обучения", вариант 1:
	* Проверка открытия страницы netology.ru (вводим url в браузере);
	* Проверка наличия на странице заголовка "Направления обучения" (находим данный раздел путем прокрутки страницы netology.ru);
	* Проверка наличия кнопки "Полный каталог" под заголовком "Направления обучения" и всех программ обучения (делаем клик по кнопке "Полный каталог");
	* Проверка появления строки поиска (вводим "Тестировщик ПО" в строке поиска);
	* Проверка появления под строкой поиска необходимого курса (делаем клик по курсу)
	
	5. Переход к тестированию возможности записи на обучение "Тестировщик ПО" со страницы netology.ru через полный каталог в "Направления обучения", вариант 2:
	* Проверка открытия страницы netology.ru (вводим url в браузере);
	* Проверка наличия на странице заголовка "Направления обучения" (находим данный раздел путем прокрутки страницы netology.ru);
	* Проверка наличия кнопки "Полный каталог" под заголовком "Направления обучения" и всех программ обучения (делаем клик по кнопке "Полный каталог");
	* Проверка появления строки заголовка "Направления обучения" и кнопки "Программирование" (делаем клик по кнопке);
